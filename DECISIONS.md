...
- The user confirmed the laser and buttons work with the standalone laser-button test. The servo is labeled T / ANKONGRC micro servo 9g SG90 analog, reported as a 180-degree positional type, powered from the converter's 5 V output. The user confirmed it moves freely on GPIO26 and authorized a 544–2400 microsecond broad travel test. Its physical endpoints, available torque, and water mechanism are not yet calibrated. Converter voltage under servo load remains unmeasured.
