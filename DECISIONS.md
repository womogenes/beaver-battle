...
- The user confirmed the laser and buttons work with the standalone laser-button test. The servo is labeled ANKONGRG micro servo 9g SG90, reported as a 180-degree positional type, powered from the converter's 5 V output. The user confirmed it moves freely on GPIO26; its pulse endpoints, available torque, and water mechanism are not yet calibrated. Converter voltage under servo load remains unmeasured.
